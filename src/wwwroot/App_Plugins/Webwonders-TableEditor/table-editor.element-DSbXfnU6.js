...
let u = class extends y(f) {
  ...
  _moveCol(e, t) {
    ...
    for (const r of i.rows) {
      const [d] = r.cells.splice(e, 1);
      r.cells.splice(a, 0, d);
    }
    this._commit(i);
  }
  _onRowDragStart(e, t) {
...
c([
  g()
], u.prototype, "_dragOverRowIndex", 2);
c([
  g()
], u.prototype, "_dragColIndex", 2);
c([
  g()
], u.prototype, "_dragOverColIndex", 2);
u = c([
